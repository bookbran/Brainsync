        ...
        <div className="max-w-6xl mx-auto text-center text-white relative">
          ...
          <div className="bg-white bg-opacity-10 backdrop-blur-sm rounded-xl p-8 max-w-4xl mx-auto mb-12">
            ...
            <div className="text-left space-y-4 text-lg leading-relaxed">
              ...
              <p>
                <strong>You're not dead anymore.</strong> You can cast spells again. You can help your party. 
              ...
              <p>
                ...
                Maybe you're in "dead party member" mode right now—feeling overwhelmed, paralyzed by choices, 
    ...
    <section id="waitlist" className="py-20 px-4 bg-gradient-to-br from-blue-600 via-purple-600 to-pink-600">
      <div className="max-w-4xl mx-auto text-center text-white">
        ...
        <p className="text-xl mb-12 text-white opacity-90">
          Join the{' '}
          <span className="text-4xl font-bold text-yellow-400 px-2 py-1 rounded hover:bg-white hover:bg-opacity-10">
            {waitlistCount}
          </span>{' '}
          waitlist and be among the first ADHD adults to experience goodberry.
        </p>
