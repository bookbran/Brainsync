...
CREATE TABLE IF NOT EXISTS conversations (
  ...
  conversation_type VARCHAR(50) NOT NULL, -- 'onboarding', 'sunday_planning', 'brain_trap', 'structured_prioritization'
  session_goal TEXT,
...
-- 5. Test basic user creation (Optional - remove test data after)
-- INSERT INTO users (email, name) VALUES ('test@goodberry.ai', 'Test User');
-- SELECT id, email, name, created_at FROM users WHERE email = 'test@goodberry.ai';
-- DELETE FROM users WHERE email = 'test@goodberry.ai';

-- ========================================
-- 🎯 SECTION 11: MIGRATION FUNCTION
-- ========================================

-- Function to migrate existing waitlist users to main users table
...
BEGIN
    ...
    RAISE NOTICE '1. Run validation queries to confirm setup';
